            ...
            <div class="c-header__right">
                ...
                <div class="c-search width-100">
                    <form action="{{route('post.search')}}" class="c-search__form position-relative">
                        <input type="text" name="search" class="c-search__input" placeholder="جستجو کنید"
            ...
            <div class="c-header__left">
                ...
                @guest
                    <div class="c-button__login-regsiter">
                        <div>
                            <a class="c-button__link c-button--login" href="{{route('login')}}">ورود</a>
                        </div>
                        <div>
                            <a class="c-button__link c-button--register" href="{{route('register')}}">ثبت نام</a>
                        </div>
                    </div>
                @else
                    <div style="width: 180px;">
                        <div class="dropdown-select wide" id="dropdown-user"
                             onclick="toggleUserDropDown()" tabindex="0">
                        <span class="current">
                            {{ auth()->user()->name }}
                        </span>
                            <div class="list">
                                <ul>
                                    <li class="option"
                                        data-value="0" data-display-text="">
                                        <a href="{{route('profile')}}">پروفایل</a>
                                    </li>
                                    <li class="option "
                                        data-value="0" data-display-text="" onclick="logoutUser()">
                                        خروج
                                    </li>
                                </ul>
                        ...
                        <div class="nav__sub">
                            <div class="container d-flex item-center flex-wrap container--nav">
                                @foreach($category->children as $categoryChild)
                                    <a href="{{route('category.show', $categoryChild->slug)}}"
                                       class="nav__link">{{$categoryChild->name}}</a>
                                @endforeach
                            </div>
                        </div>
                    </li>
...
<footer class="footer">
    ...
    <div class="container">
        <div class="footer__links">
            ...
            <a href="" class="footer__link">لینک دوم</a>
            <a href="" class="footer__link">لینک سوم</a>
            <a href="" class="footer__link">لینک چهارم</a>
            <a href="" class="footer__link">لینک پنجم</a>
            <a href="" class="footer__link">لینک ششم</a>
        </div>
