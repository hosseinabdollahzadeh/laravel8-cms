    ...
    <main>
        <div class="container article">
            <article class="single-page">
                <div class="breadcrumb">
                    <ul class="breadcrumb__ul">
                        <li class="breadcrumb__item">
                            <a href="{{route('landing')}}" class="breadcrumb__link">بخش مقالات</a>
                        </li>
                        <li class="breadcrumb__item">
                            <a href="{{route('post.show', $post->slug)}}" class="breadcrumb__link">{{$post->title}}‌</a>
                        </li>
                    </ul>
                </div>
                <div class="single-page__title">
                    ...
                    @auth
                        <span class="single-page__like"
                              @if($post->is_user_liked) single-page__like--is-active @endif></span>
                    @endauth
                </div>
        ...
        <div class="container">
            <div class="comments" id="comments">
                ...
                @else
                    <p>شما برای ارسال نظر باید وارد سایت شوید !</p>
                @endauth
