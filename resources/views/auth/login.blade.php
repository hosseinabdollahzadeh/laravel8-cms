        ...
        <div class="container">
            <div class="sign-page">
                ...
                <form class="sign-page__form" action="{{route('login.store')}}" method="POST">
                    ...
                    @error('email')
                    <p style="margin-bottom: 1rem; color: #D8000C; text-align: right;">
                        {{$message}}
                    </p>
                    @enderror
                    ...
                    <button class="btn btn--blue btn--shadow-blue width-100 " type="submit">
                        ورود به سایت
                    </button>
            ...
            <p class="sign-page__title">
                نام کاربری جهت ورود ادمین: admin@admin.test
                <br>
                نام کاربری جهت ورود نویسنده: author@author.test
                <br>
                نام کاربری جهت ورود یوزر عادی: user@user.test
            </p>
        </div>
    </main>
</x-app-layout>
